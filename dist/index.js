...
const picomatch = __webpack_require__(157);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core_1 = __webpack_require__(977);
const promise_retry_1 = __importStar(__webpack_require__(682));
...
class Uploader {
    ...
    async uploadFile(entry) {
        ...
        return (0, promise_retry_1.default)(async (attempt) => {
            const buffer = fs_1.default.readFileSync(entry.fullPath);
